    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">  FUNDS TRANSFER COMPLETION</h1>
          <p class="mb-4"> 
		 <u>   </u>
		  </p>
...
<center><div class="progress">
 <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="100.00" aria-valuemin="0" aria-valuemax="100" style="width:100.0%">
      100.0%
    </div>
     
</div></center>
<center><h3> Funds Transfer will be completed in Seven(7) to Fourteen(14) working days.</h3></center>
    ...
    <table width="550" border="0" cellpadding="5" cellspacing="1" class="entryTable">
      ...
      <tr>
        <td width="260" height="30" class="label"><strong> Internal Revenue Service Code</strong></td>
