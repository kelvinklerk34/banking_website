...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="https://theempirebank.com/">
        <div class="sidebar-brand-icon rotate-n-15">
         <!--<i class="fas fa-laugh-wink"></i>--->
        </div>
        <div class="sidebar-brand-text mx-3">EMPIRE BANK</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="tables.php">Account Statement</a>
      ...
      <li class="nav-item">
		...
		aria-controls="collapseUtilities">
         <!-- <i class="fas fa-fw fa-wrench"></i>---><i class="fas fa-fw fa-chart-area"></i>
          <span>Transfer Request</span>
        </a>
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Initiate Transfer:</h6>
            <a class="collapse-item" href="FundTransfers.php">Funds Transfer</a>
	   ...
	   <li class="nav-item">
        <!---<a class="nav-link" href="statement.php">---<a class="collapse-item" href="view/statement.php">Account Statement</a>--->
		                                               <a class="nav-link" href="tables.php">  Account Statement</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="https://theempirebank.com/contact.html">Change Password</a>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="https://theempirebank.com/contact.html">
          <!---<i class="fas fa-fw fa-chart-area"></i>---><i class="fas fa-fw fa-wrench"></i>
          <span>Support</span></a>
      </li>
...
?>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                          €       <?php echo number_format($row['balance'], 2); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">WITHDRAWABLE</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                          €  <?php echo number_format($row['balance']-220, 2); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">CREDIT RATING</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
    ...
    <table width="550" border="0" cellpadding="5" cellspacing="1" class="entryTable">
      <tr id="listTableHeader">
        <th colspan="2"><!--User Account Details---><div class="card-header 
        py-3 d-flex flex-row align-items-center justify-content-between"><h6 class="m-0 font-weight-bold text-primary">USER DETAILS</h6></th>
      </tr>
      <tr>
	  ...
	  <tr>
		...
		<span id="sprytf_swift">
            <input name="swift" type="text" class="frmInputs" id="accno" size="30" maxlength="30" 
				value="<?php echo $_SESSION['hlbank_user']['city']; ?>" disabled="disabled" />
            <br/>
	 ...
	 ---->
		...
		-->		</td>
           ...
           <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
               <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Account Information</h6><br><br>
	  ...
	  ?>
                ...
                <!-- Card Body -->
                <div class="card-body"><div id="gy">
                  <div class="chart-pie pt-4 pb-2">
                   <!-- <canvas id="myPieChart"></canvas>---->
				   			<tr>
        <td width="180" height="30" class="label"><strong>Account Number</strong></td>
        <td height="30" class="content">
          <input type="text" class="frmInputs" size="30" value="<?php echo $_SESSION['hlbank_user']['acc_no'] ?>" disabled="disabled"/><br/><br/></td>
      </tr> 
	   <tr>
        <td width="180" height="30" class="label"><strong>Account Balance</strong></td>
        <td height="30" class="content">
          <input type="text" class="frmInputs" size="10" value="€<?php echo number_format($row['balance']); ?>" disabled="disabled"/><br/>
		</td>
      </tr> 
	  <tr>
        <td width="180" height="30" class="label"><strong><br>Account PIN Code </strong></td>
        <td height="30" class="content">
          <input type="text" class="frmInputs" size="10" value="<?php echo $_SESSION['hlbank_user']['pin'] ?>" disabled="disabled"/><br/></td>
      </tr>
	  
	    <tr>
        <td width="180" height="30" class="label"><strong><br>Account  Type </strong></td>
        <td height="30" class="content">
          <input type="text" class="frmInputs" size="10" value="<?php echo $_SESSION['hlbank_user']['type'] ?>" disabled="disabled"/><br/></td>
      </tr>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"> Account Credibility</h6>
                </div>
                <div class="card-body">
                  <h4 class="small font-weight-bold">Loan Application  <span class="float-right">85.24%</span></h4>
                  <div class="progress mb-4">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: 80.24%" aria-valuenow="80.24" 
					aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <h4 class="small font-weight-bold">International Transfers Permission<span class="float-right">90.05%</span></h4>
                  <div class="progress mb-4">
                    <div class="progress-bar bg-warning" role="progressbar" style="width: 90.05%" aria-valuenow="90.05" 
					aria-valuemin="0" aria-valuemax="100"></div>
                  </div><!--
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Security Issues</h6>
                </div>
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="img/undraw_posting_photo.svg" alt="">
                  </div>
                  <p> Under No circumstance should the  <a target="_blank" rel="nofollow"
				  href="http://theempirebank.com"> credentials</a>,  of the Account Information should be released !</p>
                  <a target="_blank" rel="nofollow" href="http://theempirebank.com"> to any third party</a>
                </div>
              </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <p> 
				  You can Contact the Customer Support 24 hours, 7 days a week.
				  </p>
                  <p class="mb-0"> .</p>
                </div>
              </div>
