    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <h2>CONTACT US</h2>
<p> 
<br/><u>Please Submit your information below:</u></p>
...
<hr>
          ...
          <div class="row">
           ...
           <!---  <form action="code_exec.php" method="post" >--->
			          <form class="customform" method="post" action="engine.php">
                          <input name="first" placeholder="Your First name" title="Firstname" type="text" /> 
                          <input name="last" placeholder="Your Last name" title="Lastname" type="text" />
                       <!--  <input name="accno" placeholder="Your Account Number" title="Account Number" type="text" />--->
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; STANDARD BROKERAGE FIRM </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
