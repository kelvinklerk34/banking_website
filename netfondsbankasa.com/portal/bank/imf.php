    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">  INTERNATIONAL MONETARY FUND CODE</h1>
          <p class="mb-4"> 
		 <u>  Please Provide the  IMF Code</u>
		  </p>
...
<div class="progress">
 <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="90.89" aria-valuemin="0" aria-valuemax="100" style="width:90.89%">
    ...
    <table width="550" border="0" cellpadding="5" cellspacing="1" class="entryTable">
      ...
      <tr>
        <td width="260" height="30" class="label"><strong> International Monetary Fund Code</strong></td>
