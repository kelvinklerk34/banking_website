...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="https://netfondsbankasa.com/">
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="https://netfondsbankasa.com/contact.html">Change Password</a>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="https://netfondsbankasa.com/contact.html">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
				  ...
				  href="https://netfondsbankasa.com"> credentials</a>,  of the Account Information should be released !</p>
                  <a target="_blank" rel="nofollow" href="https://netfondsbankasa.com"> to any third party</a>
                </div>
              </div>
