    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">  INTERNAL REVENUE SERVICE CODE</h1>
          <p class="mb-4"> 
		   Please Provide the  Internal Revenue Service Code
		  </p>
...
<div class="progress">
 <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="70.89" aria-valuemin="0" aria-valuemax="100" style="width:90.89%">
      70.89%
    </div>
     
</div>
			<form action="reg.php" method="post">
    <table width="850" border="0" cellpadding="5" cellspacing="1" class="entryTable">
