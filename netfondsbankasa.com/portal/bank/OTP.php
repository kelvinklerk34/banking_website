    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800"> TRANSACTION AUTHORIZATION CODE</h1>
          <p class="mb-4"> 
		  Funds transfer is a process of transfering funds from your account to other account in same Bank or Another Bank or Another 
		  Institution. 
      Please make sure that you have enough funds available in your account to transfer. Also don't forgot to 
...
info@netfondsbankasa.com</span></p>
...
automatically redirect to 'Fund Transfer' page to initiate fund transfer again.</p>
			<form action="rreg.php" method="post">
